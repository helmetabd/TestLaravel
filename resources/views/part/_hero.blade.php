<section class="relative h-72 bg-laravel flex flex-col justify-center align-center text-center space-y-4 mb-4">
    ...
    <div class="z-10">
        ...
        <p class="text-2xl text-gray-200 font-bold my-4">
            <span class="text-white">Li</span>st o<span class="text-[#77a1b5]">f</span> categori<span class="text-black">es</span>
        </p>
        <p class="text-2xl text-gray-200 font-bold my-4">
            Find or post Category
        </p>
        <div>
            <a href="register.html" class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 hover:text-black hover:border-black">
                Sign Up to List a New Category
            </a>
        </div>
    </div>
</section>